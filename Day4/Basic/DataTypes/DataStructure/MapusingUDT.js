...
function purchaseProduct(productId, quantity) {
    if (productStock.has(productId)) {
        ...
        if (product.qty >= quantity) {
            ...
            console.log(`✅ Purchased ${quantity} ${product.productname}(s). Remaining stock: ${product.qty}`);
            ...
            console.log(`❌ Not enough stock for ${product.productname}. Only ${product.qty} left.`);
        }
    }
    else {
